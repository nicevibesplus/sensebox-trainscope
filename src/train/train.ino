...
static esp_err_t index_handler(httpd_req_t *req){
    const char* html = "<html><head><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"></head>"
                       "<body style=\"text-align:center; font-family:Arial; background:#222; color:#fff;\">"
                       "<h1>TrainSense Live</h1>"
                       "<img src=\"/stream\" style=\"width:400px; height:400px; image-rendering: pixelated; border: 2px solid #fff; transform: rotate(-90deg);\">"
                       "</body></html>";
...
void setup() {
  ...
  pCharacteristic = pService->createCharacteristic(BLEUUID((uint16_t)0x2A56), 
